...
Returns a list of all positions matching the conid. For portfolio models the conid could be in more than one model, returning an array with the name of the model it belongs to.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
  **body** | [**Body1**](Body1.md)| accounts info | 
...
> ::models::InlineResponse20014 portfolio_positions_conid_get(conid)
Positions by Conid
