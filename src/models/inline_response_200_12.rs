...
impl InlineResponse20012 {
  ...
  pub fn with_accounts(mut self, accounts: Vec<String>) -> InlineResponse20012 {
    self.accounts = Some(accounts);
    self
  }
  ...
  pub fn with_aliases(mut self, aliases: Value) -> InlineResponse20012 {
    self.aliases = Some(aliases);
    self
  }
  ...
  pub fn with_selected_account(mut self, selected_account: String) -> InlineResponse20012 {
    self.selected_account = Some(selected_account);
    self
  }
