...
impl InlineResponse2008 {
  ...
  pub fn with_A(mut self, A: i32) -> InlineResponse2008 {
    self.A = Some(A);
    self
  }
  ...
  pub fn with_FC(mut self, FC: String) -> InlineResponse2008 {
    self.FC = Some(FC);
    self
  }
  ...
  pub fn with_FD(mut self, FD: String) -> InlineResponse2008 {
    self.FD = Some(FD);
    self
  }
  ...
  pub fn with_FN(mut self, FN: String) -> InlineResponse2008 {
    self.FN = Some(FN);
    self
  }
  ...
  pub fn with_H(mut self, H: i32) -> InlineResponse2008 {
    self.H = Some(H);
    self
  }
