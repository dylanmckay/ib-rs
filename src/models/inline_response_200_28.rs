...
impl InlineResponse20028 {
  ...
  pub fn with_available_chart_periods(mut self, available_chart_periods: String) -> InlineResponse20028 {
    self.available_chart_periods = Some(available_chart_periods);
    self
  }
  ...
  pub fn with_column_name(mut self, column_name: String) -> InlineResponse20028 {
    self.column_name = Some(column_name);
    self
  }
  ...
  pub fn with_company_name(mut self, company_name: String) -> InlineResponse20028 {
    self.company_name = Some(company_name);
    self
  }
  ...
  pub fn with_con_id(mut self, con_id: f32) -> InlineResponse20028 {
    self.con_id = Some(con_id);
    self
  }
  ...
  pub fn with_conidex(mut self, conidex: String) -> InlineResponse20028 {
    self.conidex = Some(conidex);
    self
  }
  ...
  pub fn with_contract_description_1(mut self, contract_description_1: String) -> InlineResponse20028 {
    self.contract_description_1 = Some(contract_description_1);
    self
  }
  ...
  pub fn with_listing_exchange(mut self, listing_exchange: String) -> InlineResponse20028 {
    self.listing_exchange = Some(listing_exchange);
    self
  }
  ...
  pub fn with_sec_type(mut self, sec_type: String) -> InlineResponse20028 {
    self.sec_type = Some(sec_type);
    self
  }
  ...
  pub fn with_server_id(mut self, server_id: String) -> InlineResponse20028 {
    self.server_id = Some(server_id);
    self
  }
  ...
  pub fn with_symbol(mut self, symbol: String) -> InlineResponse20028 {
    self.symbol = Some(symbol);
    self
  }
